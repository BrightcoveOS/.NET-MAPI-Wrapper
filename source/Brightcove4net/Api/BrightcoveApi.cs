...
namespace Brightcove4net.Api
{
	...
	public partial class BrightcoveApi
	{
		...
		/// <summary>
		/// Converts json retrieved from Brightcove to an instance of the corresponding Brightcove4net model class.
		/// </summary>
		...
		/// <summary>
		/// Converts a Brightcove4net model class into the corresponding json representation
		/// </summary>
		/// <typeparam name="T"></typeparam>
